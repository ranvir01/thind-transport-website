...
8. **`docs/sales-demo.md`:** the 5-minute phone pitch to a prospective carrier — owner dashboard → paste-to-dispatch → driver POD → one-click invoice → broker tracking link → IFTA worksheet → settlement PDF → **ending in the onboarding wizard creating their company live.** Re-verify `docs/demo-script.md` end-to-end with a screen recording.
