...
agents and the Grok Bot Airtable coach both read this file.*
...
Grok Bot Airtable coach: [`docs/grok-bots/airtable-coach.instructions.md`](../grok-bots/airtable-coach.instructions.md).
