...
How: desktop New chat → select 2–6 Bots; iPhone **+ → New Group Chat**. Confirm the three Bot names, list connectors signed in, and stop. Do not create a fourth Bot. Do not git push. Do not change Cursor or Claude schedules.
