...
COMPUTER
/workspace/clients/[slug]/last.md only.

ROUTINES
None until Ranvir says so.

SKILLS
[Venture] check.

HANDOFFS
Reds on home CI → Steve. New work → gogo. You never Fire Cursor on thind-transport-website unless assigned.

METHOD
Password/2FA: hand Ranvir the Agent Computer; never paste secrets. Memory is not the record. Never SSH-tunnel the computer.

OUT OF CHARTER
Frybox, roofing, Tabletop Village, Gadget Fix, changing hosting, merging, Airtable.
```
