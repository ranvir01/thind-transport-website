...
HANDOFFS
Driver/PWA/marketing → Rex. CI/Vercel → Steve. Usage/model → Finch. Stuck twice → Em then gogo.

METHOD
Password/2FA: hand Ranvir the Agent Computer; never paste secrets. Memory is not the record. Never SSH-tunnel the computer. Reopen AGENTS.md standing rules before a hub PR.
