...
Next up by this rule: `mailbox`/`wex`, both last researched 2026-07-18 (now the sole oldest
built-adapter docs after `comdata.md` was refreshed 2026-07-22, see below). The 2026-07-22
`comdata` pass found no adapter-breaking change — the REST-pull placeholder and the file-drop
