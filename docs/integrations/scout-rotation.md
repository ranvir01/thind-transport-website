...
Next up by this rule: `dat.md`, `efs.md`, `wex.md`, `comdata.md`, `qbo.md`, `factor.md`, and
`truckstop.md` are now tied as the oldest vendor docs (2026-07-06, unchanged) since
`truckercloud.md` was refreshed 2026-07-10; take the top of that list next (`dat.md`).
