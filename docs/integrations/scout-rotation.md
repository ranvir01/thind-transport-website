...
Next up by this rule: after the 2026-07-27 `mailbox` re-pass, the oldest built-adapter doc is
`wex` (2026-07-22, now the sole tie-holder — `mailbox` moved to 2026-07-27); take `wex` next.
`truckercloud` (2026-07-20) is older still but anonymous scouting there is exhausted (five
straight total 403 walls) — skip until a human makes vendor contact. `mailbox` stays the
