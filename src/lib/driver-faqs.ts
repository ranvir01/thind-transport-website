import { COMPANY_INFO, FMCSA_LINKS, PAY_RATES, STATS, WORKPLACE } from "@/lib/constants"
...
export function driverFaqs() {
  ...
  return [
    ...
    },
    {
      ...
      answer: `What we offer today: ${cd.signOnBonus} sign-on; weekly direct deposit; paid time off and paid holidays; performance and referral bonuses; home time you pick (local, regional, or OTR at the same ${cd.local.perMile}/mile); 2024 Freightliner Cascadias; rider and pet policy; 24/7 dispatch. We do not currently offer company medical, dental, vision, life or disability insurance, or a 401(k) — we'd rather tell you now than at orientation.`,
    },
    {
    ...
    },
    {
      ...
      answer:
        "2024 Freightliner Cascadias with APU, refrigerator, inverter, and a premium sleeper. Automatic transmission available. Company trucks come with a compliant ELD already installed.",
    },
    {
    ...
    },
    {
      ...
      answer: `Mega-carriers run call centers and forced dispatch. Here you get ${oo.commission} of gross (or ${cd.local.perMile}/mile company), no forced dispatch, weekly pay, 2024 Cascadias, and a dispatcher who knows your name. ${WORKPLACE.languages} Verify us on SAFER before you apply.`,
    },
  ]
}
