...
function drawEmployerBlock(
  ...
  // For first employer, highlight as most recent/relevant
  if (num === 1) {
    drawText(page, ctx, "IMPORTANT: Start with your MOST RECENT employer", MARGIN_LEFT, y + 15, { size: FONT_SMALL, color: BLACK })
  }
...
export function buildEmploymentHistoryPages(ctx: PDFContext): PDFPage[] {
  ...
  y = drawCallout(
    page1,
    ctx,
    "REQUIRED: Complete each employer block. If not applicable, enter N/A.",
    MARGIN_LEFT,
    y,
    CONTENT_WIDTH,
    FONT_SMALL
