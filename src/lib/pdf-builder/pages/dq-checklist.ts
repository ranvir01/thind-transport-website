...
export function buildDQChecklistPage(ctx: PDFContext): PDFPage[] {
  ...
  // Footer note
  const footerY = MARGIN_BOTTOM + 5
  drawText(page, ctx, "THIS PAGE FOR INTERNAL USE ONLY - NOT TO BE GIVEN TO APPLICANT", MARGIN_LEFT + 60, footerY, { size: FONT_SMALL, color: GRAY })
