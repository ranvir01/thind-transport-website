...
const faqs = [
  {
    ...
    answer: "Our fleet consists of 2020-2022 model year trucks. We operate Freightliner Cascadias and Volvo VNL 860s/760s. All trucks are well-maintained modern equipment with APUs, ensuring you always drive reliable, comfortable trucks."
  },
  {
          ...
          >
            {[
              { 
                icon: Calendar, 
                title: "Newest Fleet", 
                desc: "Well-maintained 2020-2022 model trucks with APUs and current safety features.",
                highlight: "2020-2022 Only"
              },
              { 
                icon: Zap, 
                title: "APU Standard", 
