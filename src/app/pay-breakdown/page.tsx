      ...
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <div className="prose prose-lg max-w-none text-gray-700">
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-navy mb-4">How does the 90% split work?</h2>
            <p className="text-xl leading-relaxed mb-6 font-medium text-navy/80">
              It's simple mathematics, not magic. <strong>We take 10% for admin/dispatch. You keep 90%.</strong> We pass through 100% of fuel surcharges.
            </p>
            <p className="mb-4">
            ...
            <div className="bg-orange/5 border-l-4 border-orange p-4 my-6">
              ...
              <p className="m-0">If the load pays $1,000, you get $900. Period.</p>
            </div>
            <ul className="list-disc pl-6 space-y-2 mb-6 marker:text-orange">
              <li><strong>Linehaul:</strong> You keep 90% of the gross rate.</li>
              <li><strong>Fuel Surcharge:</strong> We pass through 100% of fuel surcharges to you.</li>
              <li><strong>Accessorials:</strong> You keep 90% of detention, layover, and stop pay.</li>
            </ul>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center border-b border-gray-100 pb-3">
                  <span className="font-medium">Your Share (90%)</span>
                  <span className="font-bold text-navy text-lg">$2,700.00</span>
                </div>
                ...
                <div className="flex justify-between items-center pt-2">
                  ...
                  <span className="font-black text-3xl text-orange">$2,700.00</span>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-navy mb-4">Who pays 90% split?</h2>
            <p>
              Thind Transport pays 90% split to all owner operators. We believe that if you own the truck and do the driving, you should keep the majority of the revenue. This structure is designed to help owner operators succeed in volatile markets by maximizing their revenue per mile.
            </p>
          </section>
