...
const testimonials = [
  {
    ...
    years: "3 years",
    rating: 5,
    text: "The 90% commission rate is unbeatable! I was keeping 75% at my old company. With Thind Transport, <strong class='text-orange-400 font-bold'>I'm taking home an extra $2,800 every month.</strong> Freight is steady and dispatch actually listens.",
  ...
  },
  {
    ...
    years: "5 years",
    rating: 5,
    text: "Been with Thind since 2020. Started with one truck, now running three. <strong class='text-orange-400 font-bold'>The 90% commission and consistent freight made it possible to grow my business.</strong> Best decision I ever made.",
    fleet: "3 trucks",
  ...
  },
  {
    ...
    years: "2 years",
    rating: 5,
    text: "As a female owner operator, finding a good company was tough. Thind treats everyone with respect. 90% commission, no forced dispatch. <strong class='text-orange-400 font-bold'>Highly recommend!</strong>",
  ...
  },
  {
    ...
    years: "1 year",
    rating: 5,
    text: "Switched from a mega carrier to Thind last year. Night and day difference. I control my schedule, pick my loads, and the 90% commission speaks for itself. <strong class='text-orange-400 font-bold'>My take-home doubled.</strong>",
