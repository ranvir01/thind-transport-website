...
const botResponses: Record<string, string> = {
  "commission": "Owner Operators keep 90% of the gross revenue - one of the highest in the industry! Plus, 100% of fuel surcharge is passed through to you. Would you like to calculate your potential earnings?",
...
export function ChatWidget() {
  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      setMessages([{
        id: "1",
        text: "Hi! 👋 I'm here to help you learn about driving for Thind Transport. Ask me anything about our 90% commission, equipment, or routes!",
        sender: "bot",
        timestamp: new Date(),
      }])
    }
  ...
  const getBotResponse = (text: string): string => {
    ...
    if (lower.includes("commission") || lower.includes("90") || lower.includes("91") || lower.includes("percent") || lower.includes("pay")) {
  ...
  return (
    <>
      {/* Chat Button */}
      <motion.div
        className="fixed bottom-24 right-4 z-[60] md:bottom-6 md:right-6"
          ...
          {showBubble && !isOpen && (
            ...
            >
              ...
              <p className="text-sm text-gray-700 font-medium">
                👋 Hi! Have questions about our 90% commission? I'm here to help!
              </p>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-40 right-4 z-[60] w-80 max-w-[calc(100vw-2rem)] bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden md:bottom-24 md:right-6 md:w-96"
          >
            {/* Header */}
