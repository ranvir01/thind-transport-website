  ...
  return (
    <section className="py-24 bg-gradient-to-b from-white to-slate-50">
      <div className="container max-w-4xl mx-auto">
        ...
        <div
          className="bg-white rounded-3xl p-8 md:p-12 min-h-[450px] flex items-center justify-center relative overflow-hidden border border-slate-200 shadow-2xl shadow-slate-200/50"
          data-light
        >
          ...
          {step === questions.length && qualified && (
            <div
              key="qualified"
              className="motion-safe:animate-dropdown-in text-center relative z-10"
            >
          ...
          {step === questions.length && !qualified && (
            ...
            >
              ...
              <p className="text-lg text-slate-600 mb-8 max-w-md mx-auto leading-relaxed">
                While you may not meet our <strong>Owner Operator</strong>{" "}
                requirements yet, we often have positions for Company Drivers or
