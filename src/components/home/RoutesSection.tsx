            ...
            <Card className="h-full group border border-white/10 bg-white/5 hover:bg-white/10 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 backdrop-blur-sm">
              <CardContent className="p-4 sm:p-6 md:p-8">
                <div className="text-center mb-4 sm:mb-6">
                  ...
                  <Badge className="mb-2 sm:mb-3 bg-blue-500/20 text-blue-300 border-blue-500/30 font-bold text-xs">
                    Home Every Night
                  </Badge>
                  ...
                  <div className="flex flex-col items-center gap-0.5 sm:gap-1 mb-2">
                    ...
                    <span className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-blue-500/80">
                      Target Annual Pay
                    </span>
                  </div>
                ...
                <div className="bg-gradient-to-br from-blue-900/50 to-blue-800/50 rounded-xl sm:rounded-2xl p-3 sm:p-5 border border-blue-500/20">
                  <p className="text-xs sm:text-sm font-bold mb-2 sm:mb-3 text-blue-200">
                    Typical Day:
                  </p>
            ...
            <Card className="h-full group border border-green-500/20 bg-white/5 hover:bg-white/10 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 ring-1 ring-green-500/10 backdrop-blur-sm">
              <CardContent className="p-4 sm:p-6 md:p-8">
                <div className="text-center mb-4 sm:mb-6">
                  ...
                  <Badge className="mb-2 sm:mb-3 bg-green-500/20 text-green-300 border-green-500/30 font-bold text-xs">
                    Home weekly
                  </Badge>
                  <h3 className="text-xl sm:text-2xl font-black mb-2 sm:mb-3 text-white">
                    Regional Routes
                  ...
                  <div className="flex flex-col items-center gap-0.5 sm:gap-1 mb-2">
                    ...
                    <span className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-green-500/80">
                      Target Annual Pay
                    </span>
                  </div>
                ...
                <div className="bg-gradient-to-br from-green-900/50 to-green-800/50 rounded-xl sm:rounded-2xl p-3 sm:p-5 border border-green-500/20">
                  <p className="text-xs sm:text-sm font-bold mb-2 sm:mb-3 text-green-200">
                    Typical Week:
                  </p>
            ...
            <Card className="h-full group border border-white/10 bg-white/5 hover:bg-white/10 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 backdrop-blur-sm">
              <CardContent className="p-4 sm:p-6 md:p-8">
                <div className="text-center mb-4 sm:mb-6">
                  ...
                  <Badge className="mb-2 sm:mb-3 bg-purple-500/20 text-purple-300 border-purple-500/30 font-bold text-xs">
                    Highest earnings
                  </Badge>
                  <h3 className="text-xl sm:text-2xl font-black mb-2 sm:mb-3 text-white">
                    OTR Routes
                  ...
                  <div className="flex flex-col items-center gap-0.5 sm:gap-1 mb-2">
                    ...
                    <span className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-purple-500/80">
                      Target Annual Pay
                    </span>
                  </div>
                ...
                <div className="bg-gradient-to-br from-purple-900/50 to-purple-800/50 rounded-xl sm:rounded-2xl p-3 sm:p-5 border border-purple-500/20">
                  <p className="text-xs sm:text-sm font-bold mb-2 sm:mb-3 text-purple-200">
