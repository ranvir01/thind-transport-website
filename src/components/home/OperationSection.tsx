      ...
      <div className="container relative z-10 px-4">
        <Reveal className="mb-10 max-w-3xl md:mb-14">
          ...
          <h2 className="mb-3 text-white">
            How you&apos;ll{" "}
            <span className="text-gradient-accent">actually run</span>
          </h2>
          <p className="max-w-2xl text-base text-steel-300 md:text-lg">
            No mystery middle layer. Here&apos;s the loop between you, the load
            board, and the desk in Kent.
          </p>
        </Reveal>
          ...
          <div className="space-y-6 md:space-y-8">
              ...
              return (
                ...
                >
                  <div className="relative flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-fleet border border-orange/30 bg-orange/10">
                    ...
                    <span className="absolute -right-1.5 -top-1.5 flex h-5 w-5 items-center justify-center rounded-full bg-orange-600 font-display text-m-micro font-bold text-white">
                      {index + 1}
                    </span>
                  </div>
                  <div>
                    ...
                    <p className="text-sm leading-relaxed text-steel-300 md:text-base">
                      {step.body}
                    </p>
                  </div>
                </Reveal>
            ...
            >
              ...
              <p className="text-sm text-steel-300">
                Verified carrier on the DAT network
              </p>
              <a
