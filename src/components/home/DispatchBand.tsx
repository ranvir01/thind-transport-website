        ...
        <div className="container relative z-10 flex min-h-[60vh] items-center px-4 py-16 md:min-h-[70vh] md:py-24">
          ...
          >
            ...
            <h2 className="mb-5 text-white">
              Call dispatch. <span className="text-gradient-accent">A real person answers.</span>
            </h2>
            <p className="mb-8 max-w-xl text-lg text-steel-200">
              No phone trees, no overseas queue, no being treated like a truck number. When you call Thind, you reach
              people who know your name, your lanes, and your loads &mdash; days, nights, and weekends.
            </p>
