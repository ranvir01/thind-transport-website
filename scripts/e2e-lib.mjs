 ...
 *
 * State-consuming smokes (dispatch, invoices, settlements, advances) call
 ...
 * applies advances, advances decides requests) start from the exposure totals
 * and load lifecycle the seed pins. Runs only against a localhost BASE — a
