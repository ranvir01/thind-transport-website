...
function main() {
  ...
  if (json) {
    // No process.exit() here: exiting explicitly drops stdout past the 64KB
    // pipe buffer, which truncated the JSON consumers like agent-loop-status
    // parse (and made "pending" silently read as 0).
