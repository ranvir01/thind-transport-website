...
function main() {
  ...
  if (json) {
    // No process.exit() here: stdout to a pipe flushes asynchronously past ~64KB,
    // and exit() drops the unflushed tail — agent-loop-status got truncated JSON
    // and reported "Pending: 0" against 200+ real branches.
