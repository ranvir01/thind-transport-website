...
function main() {
  ...
  if (json) {
    // No process.exit() here: exiting explicitly kills the process before
    // piped stdout flushes, so callers (agent-loop-status) received truncated
    // JSON and mis-reported 217 pending branches as 0.
