...
function main() {
  ...
  if (json) {
    ...
    // stdout mid-JSON (async flush), which is how agent:status ended up
    // parsing "0 pending" while 376 branches were pending. Return and let the
    // process drain stdout naturally.
