...
function main() {
  ...
  if (json) {
    // No process.exit() here: exiting right after a large console.log drops
    // unflushed stdout when piped (agent-loop-status.mjs reads us via execSync)
    // and the consumer gets truncated JSON.
