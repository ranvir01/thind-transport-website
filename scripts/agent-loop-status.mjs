...
function main() {
  ...
  try {
    ...
    if (!Array.isArray(parsed.pending)) throw new Error("inventory JSON has no pending[] array")
  ...
  if (pendingCount === null) {
    ...
    console.log("  Do not trust 'all merged' until this is fixed. Run: npm run agent:branches")
  } else {
