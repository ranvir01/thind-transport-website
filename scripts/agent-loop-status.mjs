...
function main() {
  ...
  // In-process call instead of shelling out to `--json`: the subprocess
  // pipe truncated large payloads and the swallowed parse error reported
  // "0 pending" while agent:branches showed 200+.
