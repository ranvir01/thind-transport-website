 ...
 * Returns null (never 0) when the output is unparsable or missing the
 * `pending` array — a truncated child stdout once made this report
 * "0 pending" while 200+ branches were waiting.
 */
...
function main() {
  ...
  if (pendingCount === null) {
    ...
    console.log("  Run: npm run agent:branches (do NOT treat this as 0 pending)")
  } else {
