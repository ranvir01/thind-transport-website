 ...
 * Returns null (never 0) for empty, truncated, or shape-mismatched output so
 * callers can't mistake a broken inventory for a drained one.
 */
...
function main() {
  ...
  if (pendingCount === null) {
    console.log("\nPending claude/* branches: UNKNOWN — inventory --json output was empty or unparsable.")
    console.log("  Check directly: npm run agent:branches")
  } else {
