      ...
      <main>
        {active && history ? (
          ...
          <section className="empty">
            <h2>Ask about any venture, or say what you want done.</h2>
            <p>
              Status pulls from the live repos; requests come back as paste-ready prompts and
              backlog items. The bridge reads everything and writes nothing.
            </p>
