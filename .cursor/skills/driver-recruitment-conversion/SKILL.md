...
1. **Pay, first viewport.** Real numbers from `PAY_RATES` in `src/lib/constants.ts` (90% commission O/O, $0.65/mi company, sign-on bonuses). If a page hides pay below the fold, fix it.
